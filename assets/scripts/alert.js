// create alert for when user selects the SPPECTR work card
...
// create alert for when user selects the iDAD work card
function iDAD_alert(){
...
// create alert for when the user selects the Phone# link within Contact Me
